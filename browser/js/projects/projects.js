...
app.controller('projectsCtrl', function($scope){
  $scope.projects = [
    ...
    { name: 'SpellBook', link: 'http://immense-temple-5922.herokuapp.com/', blurb: 'An interactive story book that teaches children basic programming logic', color: 'purple1'},
